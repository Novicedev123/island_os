  ...
  return (
    ...
    >
      <div className="flex justify-between items-center">
        <h2 className="text-3xl font-black text-island-volcanic tracking-tighter">Business <span className="text-island-emerald">Settings.</span></h2>
        <button className="btn-primary px-8 py-3 rounded-2xl">
          <Save size={18} strokeWidth={3} /> Save Node Changes
        </button>
      </div>
